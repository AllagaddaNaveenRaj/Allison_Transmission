...
export default class HomePage {
  private readonly fourwardTitleLocator = "4WARD";
  //private readonly contactsLinkLocator = "Contacts";

  constructor(private page: Page) {}
  async expectfourWARDTitleToBeVisible() {
    await expect(this.page.getByTitle(this.fourwardTitleLocator)).toBeVisible({timeout: 15000})
   }
